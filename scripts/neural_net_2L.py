...
def preprocess_data(df: pd.DataFrame):
    ...
    df = df.drop(column_drop_names, axis=1)
    return df
...
def define_and_compile_model(input_shape, learning_rate=0.001):
    model = Sequential([
        ...
        Dense(15, activation='relu', input_shape=(50,)),
        Dense(1, activation='sigmoid')
    ])
    model.compile(optimizer=Adam(learning_rate=learning_rate), loss='binary_crossentropy', metrics=['accuracy'])
    return model

def train_model(model, X_train, y_train, X_val, y_val, epochs=150, file=None):
...
if __name__ == "__main__":
    ...
    output_file_path = '/Users/adityamagarde/Documents/UCR/CS240_NR/AnamolyDetection/scripts/data_proc/final_stats/double_30_15_neuron_only_graph_smote.txt'
    ...
    # List of your files
    file_paths = [
        "/Users/adityamagarde/Documents/UCR/CS240_NR/AnamolyDetection/scripts/data_proc/final_csvs/type1_labelwise_nans_avg_labelled_merged.csv",
        # "/Users/adityamagarde/Documents/UCR/CS240_NR/AnamolyDetection/scripts/data_proc/final_csvs/type2_adj_2w_pad_clean_merged.csv",
        # "/Users/adityamagarde/Documents/UCR/CS240_NR/AnamolyDetection/scripts/data_proc/final_csvs/type3_oneD_2W_df_clean_merged.csv",
        # "/Users/adityamagarde/Documents/UCR/CS240_NR/AnamolyDetection/scripts/data_proc/final_csvs/type4_twoD_2W_df_clean_merged.csv",
        # "/Users/adityamagarde/Documents/UCR/CS240_NR/AnamolyDetection/scripts/data_proc/final_csvs/type5_oneD_2W_df_clean_merged_v2.csv"
    ]
    ...
    with open(output_file_path, 'w') as f:
        for file_path in file_paths:
            ...
            model = define_and_compile_model(X_train_resampled.shape[1])
            history = train_model(model, X_train_resampled, y_train_resampled, X_val, y_val, file=f)
